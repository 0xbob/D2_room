...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _constants = __webpack_require__(/*! ../constants */ \"./src/engine/constants/index.js\");\n\nvar _constants2 = _interopRequireDefault(_constants);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar qs = function qs(object) {\n\treturn '?' + Object.keys(object).map(function (key) {\n\t\treturn key + \"=\" + object[key];\n\t}).join('&');\n};\n\nvar json = function json(response) {\n\treturn response.json();\n};\n\nvar Assets = function () {\n\tfunction Assets() {\n\t\t_classCallCheck(this, Assets);\n\t}\n\n\t_createClass(Assets, null, [{\n\t\tkey: \"downloadJSON\",\n\t\tvalue: function downloadJSON(url) {\n\t\t\treturn fetch(url).then(json);\n\t\t}\n\t}, {\n\t\tkey: \"downloadImage\",\n\t\tvalue: function downloadImage(src) {\n\t\t\treturn new Promise(function (success, reject) {\n\t\t\t\tvar image = new Image();\n\n\t\t\t\timage.onload = function () {\n\t\t\t\t\treturn success(image);\n\t\t\t\t};\n\t\t\t\timage.src = src;\n\t\t\t});\n\t\t}\n\t}, {\n\t\tkey: \"downloadActor\",\n\t\tvalue: function downloadActor(_ref) {\n\t\t\tvar look = _ref.look,\n\t\t\t    rotation = _ref.rotation;\n\n\t\t\tvar query = qs({ look: look, rotation: rotation });\n\n\t\t\treturn Assets.downloadImage(_constants2.default.ASSETS_URL + \"/avatar\" + query + \".img\");\n\t\t}\n\t}, {\n\t\tkey: \"downloadMap\",\n\t\tvalue: function downloadMap(mapID) {\n\t\t\treturn Assets.downloadJSON(_constants2.default.ASSETS_URL + \"/maps/\" + mapID + \".json\");\n\t\t}\n\t}, {\n\t\tkey: \"downloadGFX\",\n\t\tvalue: function downloadGFX(_ref2) {\n\t\t\tvar name = _ref2.name;\n\n\t\t\treturn Assets.downloadImage(_constants2.default.ASSETS_URL + \"/gfx/\" + name + \".png\");\n\t\t}\n\t}]);\n\n\treturn Assets;\n}();\n\nexports.default = Assets;\n\n//# sourceURL=webpack:///./src/engine/assets/index.js?");

/***/ }),

/***/ "./src/engine/constants/index.js":
/*!***************************************!*\
  !*** ./src/engine/constants/index.js ***!
  \***************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\nexports.default = {\n\tWIDTH: 0,\n\tHEIGHT: 0,\n\n\tGRID_COLS: 0,\n\tGRID_ROWS: 0,\n\n\tASSETS_URL: \"./static/assets\"\n};\n\n//# sourceURL=webpack:///./src/engine/constants/index.js?");
...
"use strict";
eval("\n\nvar _scene = __webpack_require__(/*! ./scene */ \"./src/engine/scene/index.js\");\n\nvar _scene2 = _interopRequireDefault(_scene);\n\nvar _map = __webpack_require__(/*! ./map */ \"./src/engine/map/index.js\");\n\nvar _map2 = _interopRequireDefault(_map);\n\nvar _constants = __webpack_require__(/*! ./constants */ \"./src/engine/constants/index.js\");\n\nvar _constants2 = _interopRequireDefault(_constants);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar canvas = document.createElement(\"canvas\");\ncanvas.width = 1000;\ncanvas.height = 700;\n\nconsole.log(_constants2.default);\n\n_scene2.default.initialize(canvas.getContext(\"2d\"));\n_map2.default.load({ mapID: 0 });\n_scene2.default.render();\n\ndocument.body.appendChild(canvas);\n\n//# sourceURL=webpack:///./src/engine/index.js?");

/***/ }),

/***/ "./src/engine/map/grid/index.js":
/*!**************************************!*\
  !*** ./src/engine/map/grid/index.js ***!
  \**************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _constants = __webpack_require__(/*! ../../constants */ \"./src/engine/constants/index.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar WALKABLE = 1;\nvar OBSTACLE = 2;\nvar OCCUPIED = 3;\n\nexports.WALKABLE = WALKABLE;\nexports.OBSTACLE = OBSTACLE;\nexports.OCCUPIED = OCCUPIED;\n\nvar Grid = function () {\n\tfunction Grid() {\n\t\t_classCallCheck(this, Grid);\n\t}\n\n\t_createClass(Grid, null, [{\n\t\tkey: \"initialize\",\n\t\tvalue: function initialize(cells) {\n\t\t\tGrid.cells = cells || [];\n\t\t}\n\t}, {\n\t\tkey: \"getNeighbors\",\n\t\tvalue: function getNeighbors(cellID) {\n\t\t\tvar coordinates = Grid.getCoordinatesFromCellID(cellID);\n\n\t\t\tvar neighbors = Grid.cells.filter(function (_ref) {\n\t\t\t\tvar x = _ref.x,\n\t\t\t\t    y = _ref.y;\n\n\t\t\t\tvar diffX = coordinates.x - x;\n\t\t\t\tvar diffY = coordinates.y - y;\n\n\t\t\t\treturn false;\n\t\t\t});\n\t\t\treturn neighbors;\n\t\t}\n\t}, {\n\t\tkey: \"getCellIDFromCoordinates\",\n\t\tvalue: function getCellIDFromCoordinates(_ref2) {\n\t\t\tvar x = _ref2.x,\n\t\t\t    y = _ref2.y;\n\n\t\t\treturn _constants.GRID_COLS * y + x;\n\t\t}\n\t}, {\n\t\tkey: \"getCoordinatesFromCellID\",\n\t\tvalue: function getCoordinatesFromCellID(cellID) {\n\t\t\tvar y = parseInt(cellID / _constants.GRID_COLS);\n\t\t\tvar x = cellID % _constants.GRID_COLS;\n\n\t\t\treturn { x: x, y: y };\n\t\t}\n\t}, {\n\t\tkey: \"changeState\",\n\t\tvalue: function changeState(cellID, state) {\n\t\t\tGrid.cells[cellID] = state;\n\t\t}\n\t}]);\n\n\treturn Grid;\n}();\n\nexports.default = Grid;\n\n//# sourceURL=webpack:///./src/engine/map/grid/index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _assets = __webpack_require__(/*! ../assets */ \"./src/engine/assets/index.js\");\n\nvar _assets2 = _interopRequireDefault(_assets);\n\nvar _grid = __webpack_require__(/*! ./grid */ \"./src/engine/map/grid/index.js\");\n\nvar _grid2 = _interopRequireDefault(_grid);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\n/*\r\n\tconst map = {\r\n\t\tgrid: [],\r\n\t\tgfx: [\r\n\t\t\t{}\r\n\t\t],\r\n\t\tactors: []\r\n\t};\r\n*/\n\n/* const message = {\r\n\tmapID: 0\t\r\n} \r\n*/\n\nvar Map = function () {\n\tfunction Map() {\n\t\t_classCallCheck(this, Map);\n\t}\n\n\t_createClass(Map, null, [{\n\t\tkey: \"load\",\n\t\tvalue: function () {\n\t\t\tvar _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {\n\t\t\t\tvar mapID = _ref.mapID;\n\n\t\t\t\tvar _ref3, grid, gfx, actors;\n\n\t\t\t\treturn regeneratorRuntime.wrap(function _callee$(_context) {\n\t\t\t\t\twhile (1) {\n\t\t\t\t\t\tswitch (_context.prev = _context.next) {\n\t\t\t\t\t\t\tcase 0:\n\t\t\t\t\t\t\t\t_context.next = 2;\n\t\t\t\t\t\t\t\treturn _assets2.default.downloadMap(mapID);\n\n\t\t\t\t\t\t\tcase 2:\n\t\t\t\t\t\t\t\t_ref3 = _context.sent;\n\t\t\t\t\t\t\t\tgrid = _ref3.grid;\n\t\t\t\t\t\t\t\tgfx = _ref3.gfx;\n\t\t\t\t\t\t\t\tactors = _ref3.actors;\n\n\n\t\t\t\t\t\t\t\tMap.grid = _grid2.default.initialize(grid);\n\t\t\t\t\t\t\t\tMap.gfx = gfx || [];\n\t\t\t\t\t\t\t\tMap.actors = actors || [];\n\n\t\t\t\t\t\t\t\tconsole.log(Map);\n\n\t\t\t\t\t\t\tcase 10:\n\t\t\t\t\t\t\tcase \"end\":\n\t\t\t\t\t\t\t\treturn _context.stop();\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t}, _callee, this);\n\t\t\t}));\n\n\t\t\tfunction load(_x) {\n\t\t\t\treturn _ref2.apply(this, arguments);\n\t\t\t}\n\n\t\t\treturn load;\n\t\t}()\n\t}, {\n\t\tkey: \"addActor\",\n\t\tvalue: function addActor(actor) {\n\t\t\tMap.actors.push(actor);\n\n\t\t\t_grid2.default.changeState(actor.cellID, _grid2.default.OCCUPIED);\n\t\t}\n\t}, {\n\t\tkey: \"removeActor\",\n\t\tvalue: function removeActor(_ref4) {\n\t\t\tvar id = _ref4.id;\n\n\n\t\t\tvar actor = Map.actors.filter(function () {\n\t\t\t\treturn null;\n\t\t\t});\n\n\t\t\t_grid2.default.changeState(actor.cellID, _grid2.default.WALKABE);\n\t\t\tMap.actors.splice(index, 1);\n\t\t}\n\t}, {\n\t\tkey: \"moveActor\",\n\t\tvalue: function moveActor(_ref5) {\n\t\t\tvar id = _ref5.id,\n\t\t\t    cellID = _ref5.cellID;\n\n\t\t\tvar actor = Map.actors.filter(function () {\n\t\t\t\treturn null;\n\t\t\t});\n\n\t\t\t_grid2.default.changeState(actor.cellID, _grid2.default.WALKABLE);\n\t\t\tactor.cellID = cellID;\n\t\t\t_grid2.default.changeState(actor.cellID, _grid2.default.OCCUPIED);\n\t\t}\n\t}]);\n\n\treturn Map;\n}();\n\nexports.default = Map;\n\n//# sourceURL=webpack:///./src/engine/map/index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _assets = __webpack_require__(/*! ../assets */ \"./src/engine/assets/index.js\");\n\nvar _map = __webpack_require__(/*! ../map */ \"./src/engine/map/index.js\");\n\nvar _map2 = _interopRequireDefault(_map);\n\nvar _screen = __webpack_require__(/*! ../screen */ \"./src/engine/screen/index.js\");\n\nvar _screen2 = _interopRequireDefault(_screen);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nvar sortGraphics = function sortGraphics(previous, next) {\n\tvar diffY = previous[\"y\"] - next[\"y\"];\n\tvar diffX = previous[\"x\"] - next[\"x\"];\n\n\tif (diffY) return diffY > 0 ? 1 : 0;\n\tif (diffX) return diffX > 0 ? 1 : 0;\n\treturn 0;\n};\n\nvar loadGraphics = function () {\n\tvar _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(items, handler) {\n\t\tvar graphics, images, index, image, _items$index, x, y;\n\n\t\treturn regeneratorRuntime.wrap(function _callee$(_context) {\n\t\t\twhile (1) {\n\t\t\t\tswitch (_context.prev = _context.next) {\n\t\t\t\t\tcase 0:\n\t\t\t\t\t\tgraphics = [];\n\t\t\t\t\t\t_context.next = 3;\n\t\t\t\t\t\treturn Promise.all(items.map(handler));\n\n\t\t\t\t\tcase 3:\n\t\t\t\t\t\timages = _context.sent;\n\n\n\t\t\t\t\t\tfor (index in items) {\n\t\t\t\t\t\t\timage = images[index];\n\t\t\t\t\t\t\t_items$index = items[index], x = _items$index.x, y = _items$index.y;\n\n\n\t\t\t\t\t\t\tgraphics.push({ image: image, x: x, y: y });\n\t\t\t\t\t\t}\n\t\t\t\t\t\treturn _context.abrupt(\"return\", graphics);\n\n\t\t\t\t\tcase 6:\n\t\t\t\t\tcase \"end\":\n\t\t\t\t\t\treturn _context.stop();\n\t\t\t\t}\n\t\t\t}\n\t\t}, _callee, undefined);\n\t}));\n\n\treturn function loadGraphics(_x, _x2) {\n\t\treturn _ref.apply(this, arguments);\n\t};\n}();\n\nvar Scene = function () {\n\tfunction Scene() {\n\t\t_classCallCheck(this, Scene);\n\t}\n\n\t_createClass(Scene, null, [{\n\t\tkey: \"initialize\",\n\t\tvalue: function initialize(context) {\n\t\t\tScene.context = context;\n\t\t}\n\t}, {\n\t\tkey: \"load\",\n\t\tvalue: function load(animations) {\n\t\t\tScene.animations = animations || [];\n\t\t}\n\t}, {\n\t\tkey: \"addAnimation\",\n\t\tvalue: function addAnimation(animation) {\n\t\t\tScene.animations.push(animation);\n\t\t}\n\t}, {\n\t\tkey: \"removeAnimation\",\n\t\tvalue: function removeAnimation(id) {\n\t\t\tScene.animations = Scene.animations.filter(function (animation) {\n\t\t\t\treturn animation.id != id;\n\t\t\t});\n\t\t}\n\t}, {\n\t\tkey: \"render\",\n\t\tvalue: function () {\n\t\t\tvar _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {\n\t\t\t\tvar actors, gfx, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _ref3, image, x, y;\n\n\t\t\t\treturn regeneratorRuntime.wrap(function _callee2$(_context2) {\n\t\t\t\t\twhile (1) {\n\t\t\t\t\t\tswitch (_context2.prev = _context2.next) {\n\t\t\t\t\t\t\tcase 0:\n\t\t\t\t\t\t\t\t_context2.next = 2;\n\t\t\t\t\t\t\t\treturn loadGraphics(_map2.default.actors, _assets.downloadActor);\n\n\t\t\t\t\t\t\tcase 2:\n\t\t\t\t\t\t\t\tactors = _context2.sent;\n\t\t\t\t\t\t\t\t_context2.next = 5;\n\t\t\t\t\t\t\t\treturn loadGraphics(_map2.default.gfx, _assets.downloadGFX);\n\n\t\t\t\t\t\t\tcase 5:\n\t\t\t\t\t\t\t\tgfx = _context2.sent;\n\n\n\t\t\t\t\t\t\t\t_map2.default.graphics = [].concat(_toConsumableArray(gfx), _toConsumableArray(actors)).sort(sortGraphics);\n\t\t\t\t\t\t\t\t_iteratorNormalCompletion = true;\n\t\t\t\t\t\t\t\t_didIteratorError = false;\n\t\t\t\t\t\t\t\t_iteratorError = undefined;\n\t\t\t\t\t\t\t\t_context2.prev = 10;\n\t\t\t\t\t\t\t\tfor (_iterator = _map2.default.graphics[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n\t\t\t\t\t\t\t\t\t_ref3 = _step.value;\n\t\t\t\t\t\t\t\t\timage = _ref3.image;\n\t\t\t\t\t\t\t\t\tx = _ref3.x;\n\t\t\t\t\t\t\t\t\ty = _ref3.y;\n\n\t\t\t\t\t\t\t\t\tScene.context.drawImage(image, x, y);\n\t\t\t\t\t\t\t\t}_context2.next = 18;\n\t\t\t\t\t\t\t\tbreak;\n\n\t\t\t\t\t\t\tcase 14:\n\t\t\t\t\t\t\t\t_context2.prev = 14;\n\t\t\t\t\t\t\t\t_context2.t0 = _context2[\"catch\"](10);\n\t\t\t\t\t\t\t\t_didIteratorError = true;\n\t\t\t\t\t\t\t\t_iteratorError = _context2.t0;\n\n\t\t\t\t\t\t\tcase 18:\n\t\t\t\t\t\t\t\t_context2.prev = 18;\n\t\t\t\t\t\t\t\t_context2.prev = 19;\n\n\t\t\t\t\t\t\t\tif (!_iteratorNormalCompletion && _iterator.return) {\n\t\t\t\t\t\t\t\t\t_iterator.return();\n\t\t\t\t\t\t\t\t}\n\n\t\t\t\t\t\t\tcase 21:\n\t\t\t\t\t\t\t\t_context2.prev = 21;\n\n\t\t\t\t\t\t\t\tif (!_didIteratorError) {\n\t\t\t\t\t\t\t\t\t_context2.next = 24;\n\t\t\t\t\t\t\t\t\tbreak;\n\t\t\t\t\t\t\t\t}\n\n\t\t\t\t\t\t\t\tthrow _iteratorError;\n\n\t\t\t\t\t\t\tcase 24:\n\t\t\t\t\t\t\t\treturn _context2.finish(21);\n\n\t\t\t\t\t\t\tcase 25:\n\t\t\t\t\t\t\t\treturn _context2.finish(18);\n\n\t\t\t\t\t\t\tcase 26:\n\t\t\t\t\t\t\tcase \"end\":\n\t\t\t\t\t\t\t\treturn _context2.stop();\n\t\t\t\t\t\t}\n\t\t\t\t\t}\n\t\t\t\t}, _callee2, this, [[10, 14, 18, 26], [19,, 21, 25]]);\n\t\t\t}));\n\n\t\t\tfunction render() {\n\t\t\t\treturn _ref2.apply(this, arguments);\n\t\t\t}\n\n\t\t\treturn render;\n\t\t}()\n\t}]);\n\n\treturn Scene;\n}();\n\n/*\r\nconst\tMAX_GRAPHICS = 100\r\nconst \tMAX_COLS = 13\r\nconst \tMAX_ROWS = 40\r\n\r\nconst \tgetRandom = (min, max) => \r\n\tMath.floor((Math.random() * max) + min);\r\n\r\nconst \tcreateGraphics = () =>\r\n{\r\n \tconst \tgraphics = []\r\n\tlet\t\ti = 0;\r\n    \r\n    while (i < MAX_GRAPHICS)\r\n    {\r\n      \tgraphics[i] = {\r\n          \tx: getRandom(0, MAX_COLS),\r\n          \ty: getRandom(0, MAX_ROWS)\r\n        };\r\n     \ti++; \r\n    }\r\n  \treturn graphics;\r\n}\r\n\r\nconst \tgraphics = createGraphics();\r\n*/\n\n\nexports.default = Scene;\n\n//# sourceURL=webpack:///./src/engine/scene/index.js?");

/***/ }),

/***/ "./src/engine/screen/index.js":
/*!************************************!*\
  !*** ./src/engine/screen/index.js ***!
  \************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _constants = __webpack_require__(/*! ../constants */ \"./src/engine/constants/index.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Screen = function () {\n\tfunction Screen() {\n\t\t_classCallCheck(this, Screen);\n\t}\n\n\t_createClass(Screen, [{\n\t\tkey: \"toPosition\",\n\t\tvalue: function toPosition(_ref) {\n\t\t\tvar x = _ref.x,\n\t\t\t    y = _ref.y;\n\n\t\t\tvar shift = y % 2 ? 0.5 : 1;\n\t\t\tvar screenX = _constants.CELL_WIDTH * x * shift;\n\t\t\tvar screenY = _constants.CELL_HEIGHT * y * shift;\n\n\t\t\treturn { screenX: screenX, screenY: screenY };\n\t\t}\n\t}]);\n\n\treturn Screen;\n}();\n\nexports.default = Screen;\n\n//# sourceURL=webpack:///./src/engine/screen/index.js?");

/***/ }),

/***/ 0:
/*!**************************************************!*\
  !*** multi babel-polyfill ./src/engine/index.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./src/engine/index.js */\"./src/engine/index.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./src/engine/index.js?");
